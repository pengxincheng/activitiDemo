...
//		ProcessEngine processEngine=ProcessEngines.getDefaultProcessEngine();
        ...
        Deployment deploy = repositoryService.createDeployment()//创建一个部署的构建器
                .addClasspathResource("diagrams/LeaveBill.bpmn")//从类路径中添加资源,一次只能添加一个资源// .addClasspathResource("diagrams/LeaveBill.png")//从类路径中添加资源,一次只能添加一个资源
                .name("请求单流程")//设置部署的名称
